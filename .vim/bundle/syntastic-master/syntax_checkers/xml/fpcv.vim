...
if exists('g:loaded_syntastic_xml_fpcv_checker')
    finish
endif
let g:loaded_syntastic_xml_fpcv_checker = 1
...
function! SyntaxCheckers_xml_fpcv_GetLocList() dict
    let makeprg = self.makeprgBuild({})

    " Filter out headers etc.
    "let errorformat = 

    let errorformat = '[a-zA-Z]* %t[A-Z]* %m'
